...
public class ParserFactory {
    ...
    public Parser getFilmixParser(String siteName, XLinkType type, int THREAD_COUNT, ApplicationContext context, CinemixServerConfiguration configuration) {
    ...
    public LinkParser getFilmixLinkParser(String siteName, XLinkType type, int THREAD_COUNT, ApplicationContext context, CinemixServerConfiguration configuration) {
    ...
    public ArticleParser getFilmixArticleParser(String siteName, XLinkType type, int THREAD_COUNT, ApplicationContext context, int splitListSize, CinemixServerConfiguration configuration) {
